...
import { Search, Filter, MoreVertical, UserPlus, Shield, Ban, Trash2 } from 'lucide-react';
...
const UserActionMenu: React.FC<{ user: User; onAction: (action: string) => void }> = ({ user, onAction }) => {
  ...
  return (
    <div className="space-y-4">
      <div className="mb-8">
        ...
        <p className="text-gray-600">Manage library members and staff accounts</p>
      </div>
